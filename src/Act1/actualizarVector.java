...
/**
 * Act 1 de la expansion de actividades Dado un vector de 5 enteros actualizar
 * cada posición de dicho vector con un número leído.
 * 
 * @author andre
 *
 */
public class actualizarVector {
	...
	public static void main(String[] args) {
		...
		// El do..while lo uso para estar siempre reiniciando el for hasta que se
		// introduzca un 0
		do {
			// El for lo uso para recorrer el array desde el 0 al 4(porque el array es 5-1)
			for (int i = 0; i < array.length; i++) {
				num = sc.nextInt();
				// La posicion de este If es primordial para que no guarde el 0 para finalizar
				// el programa
				if (num == 0) {
					break;
				}
