...
/**
 * Act 7 de la expansion de actividades
 * Leer un array y efectuar una búsqueda dicotómica.
 * @author andre
 *
 */
	...
	public static void main(String[] args) {
		...
		while(!encontrado) {
			...
			if(array[centro] > numBuscado) {
				...
				System.out.println("El numero "+numBuscado+" ha sido encontrado y esta en la posicion "+(centro+1));
				encontrado = true;
			}else {
